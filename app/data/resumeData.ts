...
export const resumeData: ResumeData = {
  ...
  introduction: [
    "무신사 솔드아웃에서 **B2C 웹 · 앱 서비스를 개발하고 운영하며 이용자 중심의 문제 해결 경험**을 쌓았고, B2B 솔루션 기업 루나소프트에서는 광고, 마케팅 어드민 신규 개발과 고도화를 주도했습니다.",
    "**새로운 기술 습득과 환경 변화에 빠르게 적응**합니다. React, Vue, Angular 등 다양한 프레임워크를 실무에서 활용했으며, 기술 간 마이그레이션 경험이 있습니다.",
    "**주도적이고 효율적인 업무 방식을 지향**합니다. 비지니스 문제 해결을 최우선으로 두고 합리적인 의사 결정을 하고자 합니다.",
    "**작성한 코드에 책임감을 가지고 개발**합니다. 팀 내 유일한 프론트엔드 개발자로도, 10명 이상의 프론트엔드 팀 일원으로도 일해보며 **근거 있는 코드 작성과 협업을 위한 설계를 고민**해왔습니다.",
    "**사람들과 함께** 일할 때 가장 큰 동기부여를 받으며, **다양한 부서와 유연하게 협업할 수 있는 커뮤니케이션 역량**을 지니고 있습니다.",
    "**‘헤맨 만큼 내 땅이다’**라는 말처럼 **경험에서 오는 성장**을 즐깁니다. 실패를 두려워하지 않고 늘 도전하고 발전하고자 합니다.",
  ],
  summary: [
    ...
    "디자이너 · 기획자 등 **타 직군과의 협업을 통한 요구사항 정리 및 기술 커뮤니케이션 경험**",
  ],
  skills: [
    {
