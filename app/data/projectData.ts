...
export const portfolioProjects: ProjectData[] = [
  ...
  {
    title: "판매 · 결제 페이지 개발 및 레거시 마이그레이션",
    company: "(주)에스엘디티",
  ...
  // ===============================
  {
    ...
    description: [
      "글로벌 상담센터 TF의 프론트엔드 초기 기획 버전 개발에 참여, 일본 시장 대응을 위한 다국어(i18n) 구조 설계",
    ...
    technicalDetails: [
      {
        title:
          "react-i18next 기반 다국어 구조 설계 (namespace 기반 도메인 분리)",
        points: [],
      },
      {
        title:
  ...
  },
  {
    ...
    description: [
      "팀 내 유일한 프론트엔드 개발자로 광고 관리 어드민 신규 개발 및 설계 담당 → 초기 개발 스택 Angular10, TypeScript",
    ...
    issues: [
      ...
      "Observable 구조의 비동기 흐름(RxJS) 의존도가 높아 프론트 로직 복잡성 증가",
    ],
    technicalDetails: [
      {
